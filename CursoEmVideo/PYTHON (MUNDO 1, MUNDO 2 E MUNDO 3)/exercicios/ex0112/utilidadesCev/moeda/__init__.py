def aumentar(x=0.0, porc=0.0, cvsao=False):
    """
...
def diminuir(x=0.0, porc=0.0, cvsao=False):
    """
...
def resumo(x=0.0, a=0.0, d=0.0):
    """
    ==> Essa função exibi uma tabelinha com todas as opções e funcções organizadas.
    :param x: Valor a ser analisado.
    :param a: Valor da porcentagem para ser aumentado.
    :param d: Valor da porcentagem para depreciar.
    :return: retorna uma tabela, com os valores organizados.
    """
    print('=' * 42)
    print(f'{"RESUMO VALOR":^42}')
    print('=' * 42)
    print(f'{"Preço analisado":.<30}:', end='')
    print(f'{moeda(x):>11}')
    print(f'{"Dobro do preço":.<30}:', end='')
    print(f'{dobrar(x, cvsao=True):>11}')
    print(f'{"Metade do preço":.<30}:', end='')
    print(f'{metade(x, cvsao=True):>11}')
    print(f'{f"Aumento de {a}%":.<30}:', end='')
    print(f'{aumentar(x, a, cvsao=True):>11}')
    print(f'{f"Redução de {d}%":.<30}:', end='')
    print(f'{diminuir(x, d, cvsao=True):>11}')
    print('=' * 42)
